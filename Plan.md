...
Шаги:
* Нажать на кнопку "Купить"
* Заполнить данные карты: номер: 1111 2222 3333 4444, срок действия валидный месяц /валидный год, имя владельца на латинице, CVC из 000,
* Оправить форму
* Получить сообщение об ошибке "Неверный формат".

#### 16.  Валидация поля "CVC/CVV", неверный формат
Шаги:
* Нажать на кнопку "Купить"
* Заполнить данные карты: номер: 1111 2222 3333 4444, срок действия валидный месяц /валидный год, имя владельца на латинице, CVC пусто,
* Оправить форму
* Получить сообщение об ошибке "Неверный формат".
